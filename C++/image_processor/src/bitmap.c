...
LoadDIBitmap(const char *filename, /* I - File to load */
             BITMAPINFO **info, BITMAPFILEHEADER* header)    /* O - Bitmap information */
    {
             ...
             BITMAPINFO **info)    /* O - Bitmap information */
{
    FILE             *fp;          /* Open file pointer */
    byte          *bits;        /* Bitmap pixel bits */
//    byte          *ptr;         /* Pointer into bitmap */
//    byte          temp;         /* Temporary variable to swap red and blue */
